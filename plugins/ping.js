...
const whatsappChannelLink = 'https://whatsapp.com/channel/0029Vaw6yRaBPzjZPtVtA80A';
...
async (conn, mek, m, { from, quoted, sender, reply }) => {
    try {
        ...
        try {
            ...
            profilePicUrl = 'https://qu.ax/bBkkd.jpg'; // Example fallback image URL
        }
        const stylishText = `
╭───────◇
...
╰───────◇
╭──〔 🌐 *Network Status* 〕──◇
├─ 🤖 *Bot Name:* ${config.botname || 'QADEER-XTECH'}
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: "𝐐ᴀᴅᴇᴇʀ-𝐗ᴛᴇᴄʜ",
                    serverMessageId: 143
                },
                // Added externalAdReply object here
                externalAdReply: {
                    title: "Qadeer-Xtech Speed",
                    body: "Powered By Qadeer Khan",
                    thumbnailUrl: 'https://qu.ax/bBkkd.jpg',
