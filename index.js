...
const sessdata = config.SESSION_ID.replace("QADEER-XTECH~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, Qadeer Xᴛᴇᴄʜ User! ✨*
...
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/Qadeer-bhai/QADEER-XMD)!   
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY Qadeer Kan_`;
 ...
 //================ownerreact==============
    if(senderNumber.includes("923151105391")){
  if(isReact) return
  m.react("🦋")
    }
if(senderNumber.includes("923151105391")){
